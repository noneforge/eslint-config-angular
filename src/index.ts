...
const config = defineConfig(
...

  {
    ...
    plugins: {
      '@angular-eslint': angular.tsPlugin as ESLint.Plugin,
    },
    languageOptions: {
      globals: {
        ...globals.browser,
...

  {
    ...
    files: ['**/*.html'],
    plugins: {
      '@angular-eslint/template': angular.templatePlugin as ESLint.Plugin,
    },
    languageOptions: {
      parser: angular.templateParser as CompatibleParser,
    },
    rules: {
